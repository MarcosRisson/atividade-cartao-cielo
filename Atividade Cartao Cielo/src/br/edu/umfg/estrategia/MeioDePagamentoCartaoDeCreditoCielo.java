...
public class MeioDePagamentoCartaoDeCreditoCielo extends MeioPagamentoCieloEstrategia {
    Calendar calendario = Calendar.getInstance();


    public MeioDePagamentoCartaoDeCreditoCielo(String numeroCartao, String cpf, String cvv, String dataValidade) throws Exception{
    ...
    public void pagar(Double valor) {
        System.out.println("Pagamento via Cartao de Credito Cielo no Valor:" + valor
    ...
    public void setNumeroCartao(String numeroCartao) throws Exception{
        if (numeroCartao.matches("[0-9]*") && numeroCartao.length() == 16){
            ...
            throw new Exception("O cartao de Credito deve conter 16 numeros");
        }
    }
    ...
    private Boolean validaCpf(String cpf) throws Exception{
        ...
        Integer soma1 = (int1 * 10) + (int2 * 9) + (int3 * 8) + (int4  * 7) +
                (int5 * 6) + (int6 * 5) + (int7 * 4) + (int8 * 3) + (int9 * 2);
        ...
        Integer soma2 = (int1 * 11) + (int2 * 10) + (int3 * 9) + (int4  * 8) +
                (int5 * 7) + (int6 * 6) + (int7 * 5) + (int8 * 4) + (int9 * 3) + (int10 * 2);

...
public class MeioDePagamentoCartaoDeDebitoCielo extends MeioPagamentoCieloEstrategia {
    Calendar calendario = Calendar.getInstance();


    public MeioDePagamentoCartaoDeDebitoCielo(String numeroCartao, String cpf, String cvv, String dataValidade) throws Exception{
